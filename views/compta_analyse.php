...
<div class="card" style="margin-top:8px">
    <div class="section-head"><h2>Ventilation analytique <?= (int) $annee ?></h2></div>
    <p class="muted small" style="padding:4px 0 12px">

...
/** @var array $totaux */ /** @var array $champs */ /** @var array $aPayer */
...
// Colonnes secondaires en plus petit
$petits = ['charges_soc', 'impots', 'charges_pat'];
$retLabels = ['ocas' => 'OCAS', 'laa' => 'LAA', 'lpp' => 'LPP', 'impot' => 'Impôt à la source'];
// Classe de mise en valeur par colonne
$cls = function (string $c) use ($petits) {
    $k = 'num';
    if ($c === 'brut') $k .= ' col-brut';        // mauve + gras
    if ($c === 'cout_emp') $k .= ' col-cout';    // gras
    if ($c === 'net') $k .= ' strong';
...
<div class="section-head">
    ...
    <form method="get" class="annee-pick">
        <input type="hidden" name="p" value="resumes">

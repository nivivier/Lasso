...
/** @var string $type */ /** @var array $periodeDefaut */ /** @var array $axes */
$typeLabels = ['ocas' => 'OCAS', 'laa' => 'LAA', 'lpp' => 'LPP'];
...
(function () {
    ...
    function maybeShowEcartRow(ecartRestant) {
        ...
        tr.innerHTML =
            ...
            `<td class="num"><input type="number" class="ecart-montant-inp" step="0.05" min="0"` +
